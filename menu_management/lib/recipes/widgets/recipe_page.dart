...
class RecipePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ReorderableListView.builder(
      ...
      // onReorderItem (unlike the deprecated onReorder) already adjusts newIndex for the item removed at oldIndex,
      // so it is the final insert index and needs no manual decrement.
