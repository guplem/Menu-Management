...
_MenuConfiguration _$MenuConfigurationFromJson(Map<String, dynamic> json) => _MenuConfiguration(
...
Map<String, dynamic> _$MenuConfigurationToJson(_MenuConfiguration instance) => <String, dynamic>{
