...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Menu&&const DeepCollectionEquality().equals(other.meals, meals));
}
...
class _Menu extends Menu {
  const _Menu({final  List<Meal> meals = const []}): _meals = meals,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Menu&&const DeepCollectionEquality().equals(other._meals, _meals));
}
