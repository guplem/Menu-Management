...
mixin _$IngredientMealRequirement {
 ...
 int get weekIndex; int get cookDayIndex; MealTime get mealTime; int get subMealIndex; String get recipeId; String get recipeName; int get people; bool get isCookEvent; List<Quantity> get quantities;
...
@useResult
$Res call({
 int weekIndex, int cookDayIndex, MealTime mealTime, int subMealIndex, String recipeId, String recipeName, int people, bool isCookEvent, List<Quantity> quantities
});
...
/// Create a copy of IngredientMealRequirement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? weekIndex = null,Object? cookDayIndex = null,Object? mealTime = null,Object? subMealIndex = null,Object? recipeId = null,Object? recipeName = null,Object? people = null,Object? isCookEvent = null,Object? quantities = null,}) {
  return _then(_self.copyWith(
weekIndex: null == weekIndex ? _self.weekIndex : weekIndex // ignore: cast_nullable_to_non_nullable
as int,cookDayIndex: null == cookDayIndex ? _self.cookDayIndex : cookDayIndex // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int weekIndex,  int cookDayIndex,  MealTime mealTime,  int subMealIndex,  String recipeId,  String recipeName,  int people,  bool isCookEvent,  List<Quantity> quantities)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IngredientMealRequirement() when $default != null:
return $default(_that.weekIndex,_that.cookDayIndex,_that.mealTime,_that.subMealIndex,_that.recipeId,_that.recipeName,_that.people,_that.isCookEvent,_that.quantities);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int weekIndex,  int cookDayIndex,  MealTime mealTime,  int subMealIndex,  String recipeId,  String recipeName,  int people,  bool isCookEvent,  List<Quantity> quantities)  $default,) {final _that = this;
switch (_that) {
case _IngredientMealRequirement():
return $default(_that.weekIndex,_that.cookDayIndex,_that.mealTime,_that.subMealIndex,_that.recipeId,_that.recipeName,_that.people,_that.isCookEvent,_that.quantities);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int weekIndex,  int cookDayIndex,  MealTime mealTime,  int subMealIndex,  String recipeId,  String recipeName,  int people,  bool isCookEvent,  List<Quantity> quantities)?  $default,) {final _that = this;
switch (_that) {
case _IngredientMealRequirement() when $default != null:
return $default(_that.weekIndex,_that.cookDayIndex,_that.mealTime,_that.subMealIndex,_that.recipeId,_that.recipeName,_that.people,_that.isCookEvent,_that.quantities);case _:
  return null;
...
class _IngredientMealRequirement extends IngredientMealRequirement {
  const _IngredientMealRequirement({required this.weekIndex, required this.cookDayIndex, required this.mealTime, required this.subMealIndex, required this.recipeId, required this.recipeName, required this.people, required this.isCookEvent, final  List<Quantity> quantities = const []}): _quantities = quantities,super._();
...
@override final  int cookDayIndex;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,weekIndex,cookDayIndex,mealTime,subMealIndex,recipeId,recipeName,people,isCookEvent,const DeepCollectionEquality().hash(_quantities));
...
/// Create a copy of IngredientMealRequirement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? weekIndex = null,Object? cookDayIndex = null,Object? mealTime = null,Object? subMealIndex = null,Object? recipeId = null,Object? recipeName = null,Object? people = null,Object? isCookEvent = null,Object? quantities = null,}) {
