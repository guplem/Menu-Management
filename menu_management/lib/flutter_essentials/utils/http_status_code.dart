class HttpStatusCode {
  ...
  static bool isInformational(int status) => status >= 100 && status < 200;
  // 2xx success
  ...
  // 3xx redirection
  static bool isRedirection(int status) => status >= 300 && status < 400;
  ...
  // 4xx client errors
  static bool isClientError(int status) => status >= 400 && status < 500;
  ...
  // 5xx server errors
  static bool isServerError(int status) => status >= 500 && status < 600;
