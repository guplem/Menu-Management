...
T getProvider<T>(BuildContext context, {required bool listen, bool suppressSingletonWarning = false}) {
  Debug.logWarning(!listen && !suppressSingletonWarning, "Trying to get a provider of type $T without listening to it going through the BuildContext. It is recommended to use the singleton pattern instead (instance of the provider).");
