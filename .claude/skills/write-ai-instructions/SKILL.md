...
- Skills live committed at `.claude/skills/<name>/SKILL.md`; subagents at `.claude/agents/<name>.md`. There are no sync scripts or mirrors; `adr/0017-agent-docs-structure.md` records why.
